...
*/
	...
	node2bbcode($doc, 'div', array('style'=>'text-align: center;'), "[center]", "[/center]");
	node2bbcode($doc, 'p', array(), "\n", "");
	node2bbcode($doc, 'div', array(), "\r", "");
	...
	$message = str_replace(array('[center][center]', '[/center][/center]', '[b][b]', '[/b][/b]', '[i][i]', '[/i][/i]'),
		array('[center]', '[/center]', '[b]', '[/b]', '[i]', '[/i]'), $message);
